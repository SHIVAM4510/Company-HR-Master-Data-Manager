...
<body>
    ...
    <div class="container">
        ...
        <form action="DesignationServlet" method="post">
            <input type="hidden" name="action" value="add">

            <label>Designation Code (Max 5 Characters):</label>
            <input type="text" name="desgCd" maxlength="5" required pattern="[A-Za-z0-9]{1,5}" title="Designation Code must be alphanumeric and up to 5 characters." />

            <label>Short Name (Max 10 Characters):</label>
            <input type="text" name="desgShortname" maxlength="10" required />

            <label>Full Name (Max 20 Characters):</label>
            <input type="text" name="desgFullname" maxlength="20" required />

            <input type="submit" value="Add Designation">
        </form>

        <a href="All_Desg.jsp" class="back-btn">Go Back</a>
    </div>
